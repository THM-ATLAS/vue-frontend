...
import Notifications from "@/views/profile/NotificationsView.vue";
import Help from "@/views/misc/HelpView.vue";
import Leaderboard from "@/views/unused/LeaderboardView.vue";
...
import Home from "@/views/landingpage/HomeView.vue";
import ModuleSearch from "@/views/module/moduleSearch/ModuleSearchView.vue";

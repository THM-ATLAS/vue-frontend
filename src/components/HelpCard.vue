    ...
    <v-container>
      <v-card-text class="text-left fontszEx grow">
        ...
        <div class="accordion-panel">
          <v-expansion-panels>
            <v-expansion-panel bg-color="#f2f5f6">
              <v-expansion-panel-title
                expand-icon="mdi-plus"
                collapse-icon="mdi-minus"
                ><b>ATLAS für Lehrende</b></v-expansion-panel-title
              >
              <v-expansion-panel-text>
                <p class="text-body-1">
                  ...
                  <br />
                  <br />
                  <v-alert icon="mdi-lightbulb" color="#dcdcdc">
            ...
            <v-expansion-panel bg-color="#f2f5f6">
              <v-expansion-panel-title
                expand-icon="mdi-plus"
                collapse-icon="mdi-minus"
                ><b>ATLAS für Studierende</b></v-expansion-panel-title
              >
              <v-expansion-panel-text>
                <p class="text-body-1">

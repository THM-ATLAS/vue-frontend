                  ...
                  <v-menu>
                    ...
                    <v-list>
                      <v-list-item
                        ...
                        :value="icon"
                      >
                        <v-list-item-icon :icon="icon" @click="setTagIcon(icon)"></v-list-item-icon>
                      </v-list-item>
                    </v-list>
                  </v-menu>
                </td>
...
//Placeholder
const currentIcon = ref("mdi-cards");
const icons = ref(["mdi-cards", "mdi-cog", "mdi-delete"]);
...
function setTagIcon(icon: any): void {
  currentIcon.value = icon;
  /**
   * In the future this should set the icon individually
   */
}
</script>
